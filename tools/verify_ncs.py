...
REGISTRY = {
    ...
    "ncs-prob-common-010": (v_prob_circular, lambda i: {1: 1, 2: 5, 3: 2, 4: 3, 5: 4}[i]),
    ...
    "ncs-prob-common-016": (v_prob_nominal, lambda i: {1: 1, 2: 5, 3: 2, 4: 3, 5: 4}[i]),
    ...
    "ncs-math-common-013": (v_atleast_woman, lambda n: {34: 1, 40: 2, 64: 3,
                                                        74: 4, 84: 5}[n]),
    "ncs-math-common-014": (v_atleast_defect, lambda p: {F(3, 10): 1, F(271, 1000): 4, F(243, 1000): 2, F(1, 1000): 3, F(729, 1000): 5}[p]),
    ...
    "ncs-res-common-003": (v_bus, lambda c: {400000: 1, 440000: 2, 480000: 3, 520000: 4, 560000: 5}[c]),
    ...
    "ncs-res-common-006": (v_pack, lambda c: {("가", "나"): 1, ("가", "나", "다"): 2,
                                              ("가", "나", "라"): 3}[c]),
    "ncs-res-common-007": (v_overtime, lambda p: {108000: 1, 126000: 2, 144000: 3, 162000: 4, 180000: 5}[p]),
    ...
    "ncs-res-common-010": (v_import, lambda p: {12328000: 1, 13400000: 2,
                                                ...
                                                16080000: 5}[p]),
    "ncs-res-common-011": (v_exec, lambda t: {(65, 1680): 1, (70, 1440): 5, (70, 1680): 2, (75, 1200): 3, (75, 1440): 4}[t]),
    ...
    "ncs-res-common-016": (lambda: (1, "롱테일은 정반대로 다수의 합에 주목한다"), lambda i: {1: 4, 2: 1, 3: 2, 4: 3, 5: 5}[i]),
    ...
    "ncs-info-common-011": (lambda: (3, "행 번호가 건너뛰는 것이 숨겨졌다는 표시"),
                            lambda i: i),
    # 012 목적에 맞게 가공 → 정보 (선지 ②)
    "ncs-info-common-012": (lambda: (2, "DIKW — 자료·정보·지식·지혜"), lambda i: {1: 1, 2: 3, 3: 2, 4: 4, 5: 5}[i]),
    ...
    "ncs-data-common-015": (v_cumulative, lambda n: {120: 1, 180: 2, 240: 3, 1760: 4, 2760: 5}[n]),
    ...
    "ncs-rule-common-014": (v_rule_group_fare, lambda n: {257040: 1, 265000: 2, 285600: 3, 294000: 4, 307000: 5}[n]),
    "ncs-rule-common-015": (v_rule_group_rate, lambda p: {0: 1, 10: 4, 15: 2}[p]),
    ...
    "ncs-math-seoulmetro-002": (v_sm_commute, lambda t: {473: 1, 475: 2, 480: 5, 482: 3, 487: 4}[t]),
    ...
    "ncs-prob-seoulmetro-002": (v_sm_triad, lambda i: {1: 1, 2: 5, 3: 2, 4: 3, 5: 4}[i]),
