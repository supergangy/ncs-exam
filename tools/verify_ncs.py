...
REGISTRY = {
    ...
    "ncs-prob-common-012": (v_prob_swot, lambda i: {1: 1, 2: 2, 3: 5, 4: 3, 5: 4}[i]),
    "ncs-prob-common-013": (v_prob_logictree, lambda i: i),
    "ncs-prob-common-014": (v_prob_timematrix, lambda i: {1: 1, 2: 4, 3: 2, 4: 3, 5: 5}[i]),
    "ncs-prob-common-016": (v_prob_nominal, lambda i: i),
    "ncs-prob-common-017": (v_prob_bullwhip, lambda i: {1: 1, 2: 5, 3: 2, 4: 3, 5: 4}[i]),
    "ncs-prob-common-018": (v_prob_5w1h, lambda i: i),
    "ncs-prob-common-019": (v_prob_route, lambda i: i),
    "ncs-rule-common-012": (v_rule_manual_first, lambda i: {1: 1, 2: 4, 3: 2, 4: 3, 5: 5}[i]),
    "ncs-rule-common-013": (v_rule_manual_threshold, lambda i: {1: 1, 2: 5, 3: 2, 4: 3, 5: 4}[i]),
    ...
    "ncs-res-common-003": (v_bus, lambda c: {400000: 1, 440000: 4, 480000: 2, 520000: 3, 560000: 5}[c]),
    "ncs-res-common-004": (v_sched, lambda h: {7: 1, 8: 2, 10: 3, 12: 4, 14: 5}[h]),
    "ncs-res-common-005": (v_meeting, lambda h: {10: 1, 11: 2, 12: 5, 14: 3, 17: 4}[h]),
    "ncs-res-common-006": (v_pack, lambda c: {("가", "나"): 1, ("가", "나", "다"): 2,
                                              ("가", "나", "라"): 3}[c]),
    "ncs-res-common-007": (v_overtime, lambda p: {108000: 1, 126000: 5, 144000: 2, 162000: 3, 180000: 4}[p]),
    ...
    "ncs-info-common-001": (v_sumif, lambda v: {1130: 1, 1450: 2, 1930: 3,
                                                2275: 4, 2595: 5}[v]),
    "ncs-info-common-002": (v_countif, lambda n: {2: 1, 3: 3, 4: 2, 5: 4, 6: 5}[n]),
    ...
    "ncs-info-common-006": (v_mid, lambda t: {"2026": 1, "KR-2": 2, "R-20": 3,
                                              "-202": 4, "26-A": 5}[t]),
    "ncs-info-common-007": (v_nested_if, lambda g: {"A": 1, "B": 4, "C": 2, "D": 3}[g]),
    "ncs-info-common-008": (v_code, lambda c: {"BS2026SPB": 1, "BS2026RLB": 2,
                                               "SL2026SPB": 3, "BS2026SPA": 4,
                                               "SP2026BSB": 5}[c]),
    "ncs-info-common-009": (v_decode, lambda t: {("대구", "2025", "전선", "A"): 4}[t]),
    ...
    # 006 저성장·고점유 → 현금젖소 (선지 ③)
    "ncs-org-common-006": (lambda: (3, "성장 2% 낮음 · 점유 38% 1위"), lambda i: {1: 1, 2: 2, 3: 5, 4: 3, 5: 4}[i]),
    ...
    "ncs-eth-common-010": (lambda: (3, "세 의미는 공존한다. 상황이 강조한 쪽을 고른다"),
                           lambda i: {1: 1, 2: 2, 3: 4, 4: 3, 5: 5}[i]),
    ...
    "ncs-data-common-001": (v_share_rail, lambda p: {29.4: 1, 31.2: 2, 33.5: 5, 35.1: 3, 38.0: 4}[round(p, 1)]),
    "ncs-data-common-002": (v_best_growth, lambda k: "ABCDE".index(k) + 1),
    "ncs-data-common-003": (v_bad_chart, lambda i: {1: 1, 2: 2, 3: 5, 4: 3, 5: 4}[i]),
    "ncs-data-common-004": (v_blank_sum, lambda n: {318: 1, 336: 2, 354: 5, 372: 3, 390: 4}[n]),
    "ncs-data-common-005": (v_blank_avg, lambda n: {231: 1, 235: 2, 239: 5, 243: 3, 247: 4}[n]),
    "ncs-data-common-006": (v_cross_seats, lambda n: {2536: 1, 2648: 2, 2776: 5, 2904: 3, 3120: 4}[n]),
    "ncs-data-common-007": (v_unit_thousand, lambda n: {1449: 1, 14490: 2, 144900: 3,
                                                        1449000: 4, 14490000: 5}[n]),
    "ncs-data-common-008": (v_wavg_fare, lambda n: {1633: 2, 1772: 1, 1900: 3, 1967: 4, 2033: 5}[n]),
    "ncs-data-common-009": (v_rank_moved, lambda n: n + 1),  # 0곳 → ① … 4곳 → ⑤
    "ncs-data-common-010": (v_amt_vs_rate, lambda t: {("A", "B"): 1}[t]),
    "ncs-data-common-011": (v_index, lambda p: {105.0: 1, 110.0: 2, 112.5: 3,
                                                115.0: 4, 120.0: 5}[round(p, 1)]),
    "ncs-data-common-012": (v_share_down, lambda t: {("늘", "줄"): 1}[t]),
    "ncs-data-common-013": (v_comp_wrong, lambda i: {1: 2, 2: 1, 3: 3, 4: 4, 5: 5}[i]),
    "ncs-data-common-014": (v_dec_pair, lambda t: {("다", "라"): 1}[t]),
    "ncs-data-common-015": (v_cumulative, lambda n: {120: 1, 180: 2, 240: 5, 1760: 3, 2760: 4}[n]),
    "ncs-data-common-016": (v_rate_times_cap, lambda k: "ABC".index(k) + 1),
    "ncs-data-common-017": (v_wavg_score, lambda p: {78.50: 1, 81.62: 4, 84.75: 2, 86.30: 3, 91.00: 5}[round(p, 2)]),
    "ncs-data-common-018": (v_cagr, lambda p: {9.5: 1, 10.0: 4, 10.5: 2, 21.0: 3, 42.0: 5}[round(p, 1)]),
    "ncs-data-common-019": (v_congestion, lambda n: {1600: 1, 1850: 2, 2160: 5, 2400: 3, 2700: 4}[n]),
    ...
    "ncs-rule-common-001": (v_rule_surcharge, lambda n: {81000: 1, 83700: 5, 27000: 2, 29700: 3, 2700: 4}[n]),
    "ncs-rule-common-002": (v_rule_exempt, lambda i: i),
    "ncs-rule-common-003": (v_rule_refund, lambda n: {28000: 1, 26600: 5, 25200: 2, 23800: 3, 22400: 4}[n]),
    "ncs-rule-common-004": (v_rule_delay, lambda n: {0: 1, 3500: 2, 7000: 3,
                                                     14000: 4, 28000: 5}[n]),
    "ncs-rule-common-005": (v_rule_pass_adult, lambda n: {28700: 1, 35000: 5, 35090: 2, 36300: 3, 63800: 4}[n]),
    ...
    "ncs-rule-common-007": (v_rule_pass_abuse, lambda n: {13500: 1, 14850: 2, 40500: 3,
                                                          41850: 4, 148500: 5}[n]),
    "ncs-rule-common-008": (v_rule_deleg_amount, lambda w: {"팀장": 2, "부장": 1, "본부장": 3, "사장": 4}[w]),
    "ncs-rule-common-009": (v_rule_deleg_public, lambda w: {"팀장": 1, "부장": 2,
                                                            "본부장": 3, "사장": 4}[w]),
    "ncs-rule-common-010": (v_rule_deleg_split, lambda w: {"본부장": 3}[w]),
    "ncs-rule-common-011": (v_rule_deleg_acting, lambda w: {"사장": 5}[w]),
    "ncs-rule-common-014": (v_rule_group_fare, lambda n: {257040: 4, 265000: 1, 285600: 2, 294000: 3, 307000: 5}[n]),
    "ncs-rule-common-015": (v_rule_group_rate, lambda p: {0: 1, 10: 2, 15: 3}[p]),
    "ncs-rule-common-016": (v_rule_gift, lambda i: {1: 1, 2: 2, 3: 4, 4: 3, 5: 5}[i]),
