...
# 본인부담률·감경률은 법률이 대통령령·고시에 위임한 값이라 문항이 자료로 준다.
# 법률이 직접 정한 것은 「초과분 전액 본인부담」(제40조 제3항 제3호)과
# 「감경은 100분의 60의 범위에서」(같은 조 제4항)라는 **상한**뿐이다.
COPAY, RELIEF = F(15, 100), F(40, 100)
RELIEF_CAP = F(60, 100)                                         # 제40조 제4항의 상한
...
CASES = [
    ...
    ("43 감경률이 법정 상한 안", RELIEF <= RELIEF_CAP,          True),
