...
시판 봉투모의고사의 **구성과 난도를 분석해** 만드는 **NCS 직업기초능력평가 모의고사** 제작 프로젝트.
지문·자료·문항은 전부 새로 쓴 창작물이며, 참고한 시판본의 원문은 저장소에 포함하지 않는다 ([저작권](#저작권)).
...
| 회차 | 기관 | 사양 | 상태 |
|---|---|---|---|
| [`r1_public`](rounds/r1_public/README.md) | 범용 공기업 (`○○공사`) | 50문항 / 60분 · 8영역 · 피듈형 | **완성** — 32쪽 / 25쪽 / 출제 이유서 18쪽 |
