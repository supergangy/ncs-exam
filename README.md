...
Python으로 문항 데이터를 관리하고, HTML 템플릿을 거쳐 **문제집·해설집·출제 이유서 PDF 3종**을 생성한다.
...
문항에 `why` 를 적어 둔 회차는 **출제 이유서**까지 세 권이 나온다.
...
│  │  ├─ README.md          후기 247건 근거 · 배분안 · 제작 이력
...
```python
{
    ...
    "questions": [{
        ...
        "each": [...5개, ①~⑤ 단평...],
        "why": {                                          # 출제 이유서용. 없어도 된다
            "근거": "★★★ 5건 — 후기에서 몇 건이 이 소재를 말했는지",
            "설계": "문항을 어떤 구조로 짰는지",
            "함정": "오답을 어디에 놓았고 어떤 오해를 하면 걸리는지",
